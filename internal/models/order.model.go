...
type Order struct {
	...
	Symbol    string      `json:"symbol" gorm:"type:varchar(10);not null" validate:"required,uppercase,min=1,max=10"`
	...
	Status    OrderStatus `json:"status" gorm:"type:varchar(20);default:'pending'" validate:"required,oneof=pending filled cancelled"`
